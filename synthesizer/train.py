...
def train(run_id: str, syn_dir: str, models_dir: str, save_every: int,
    ...
    tensorboard_folder = model_dir.joinpath("tensorboard")
    ...
    for lr in learning_rate_1k:
        tensorboard_sub_folder = tensorboard_folder.joinpath(str(lr))
        # Log Tensorboard
        writer = SummaryWriter(tensorboard_sub_folder)
